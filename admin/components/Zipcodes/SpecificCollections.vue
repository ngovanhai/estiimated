<template>
  <viewing-card title="Specific collections" :show-content="true">
    <list-specific-collections
...
module.exports = {
  components: {
    ...
    "edit-specific-collections": httpVueLoader(
  ...
  methods: {
    onGet(page) {
      ...
      this.$http
        .get(window.zipcodeSpecificCollectionsApi, {
          params: {
            action: "get",
        ...
        .then(res => {
          if (res.body.success) {
            this.specificRules = res.body.zipcodeSpecificCollections;
