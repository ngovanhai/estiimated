...
$timezone = $customer['iana_timezone'];
$xml = '<xmlrequest>
		...
		<details>
			...
			<customfields>
                ...
                <item>
					<fieldid>7</fieldid>
					<value>' . $customer['iana_timezone'] . '</value>
				</item>			
			</customfields>
		</details>
	</xmlrequest>
...
if ($result === false) {
    ...
    if ($xml_doc->status == 'SUCCESS') {
        $db->query("update shop_installed set email_shop = '$email', name_shop = '$name', phone='$phone', country='$country', timezone = '$timezone' where shop = '$shop' and app_id = $appId");
    } else {
